	...
	void FixedUpdate () {
        ...
        else
        {
            if (events == 1)
            {
                ...
                {
                    offset = new Vector3(offset.x, static_offset.y, static_offset.z + 2f);
                }
            }
            ...
            if (events == 2)
            {
                if (trigger_a || trigger_b)
                {
                    offset = new Vector3(offset.x, static_offset.y, static_offset.z - 5f);
                }
            }
            ...
            if (events == 3)
            {
                ...
                {
                    locked = true;
                    offset = new Vector3(offset.x, 0, static_offset.z - 15f);
            ...
            if (events == 5)
            {
                if (trigger_a && trigger_b)
                {
                    offset = new Vector3(offset.x, static_offset.y, static_offset.z - 2.5f);
                }
            }
            ...
            if (events == 6)
            {
                ...
                {
                    Mid_Point.i = 0.5f;
                    offset = new Vector3(static_offset.x + 2, static_offset.y - 1f, static_offset.z - 9f);
                }
            }
            ...
            {
                Mid_Point.i = 5.3f;
                offset = new Vector3(offset.x, static_offset.y, static_offset.z - 30f);
                distance_per_zoom = 0;
                zoom_power = 0;
            }
            if (events == 12)
